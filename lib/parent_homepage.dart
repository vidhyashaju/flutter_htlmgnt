...
import 'package:hostel_mgmt_sm/view_attendance.dart';
import 'package:hostel_mgmt_sm/view_contact.dart';
import 'package:http/http.dart';

class ParentHome extends StatefulWidget {
  ParentHome({Key? key, this.username, this.stuId}) : super(key: key);
